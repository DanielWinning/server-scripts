...
echo -e "Credentials are displayed below. Keep it secret, keep it safe."
echo -e ""
echo -e "root $rootPassword@localhost"
echo -e "$1 $userPassword@$3"
echo -e "$2 $appPassword@localhost"